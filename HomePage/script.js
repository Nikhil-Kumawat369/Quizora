...
// This resets the entire page if user clicks exit quiz btn during a live quiz section
DOM.body.addEventListener("click" , async (e) => {

    if(e.target.id === "MCQExitQuizBtn") {
...
// This resets the entire page if user clicks go to home btn on end quiz page
DOM.body.addEventListener("click" , async (e) => {

    if(e.target.id === "endPageGoToHomeBtn") {
